...
export default function Whatcanido() {
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center mt-2 gap-10 lg:px-30">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <Card>
            ...
            <CardContent>
              <p>
                Crafting fast, responsive, and SEO-friendly user interfaces.
                Using Next.js and React, I turn designs into interactive reality
          ...
          <Card>
            ...
            <CardContent>
              <p>
                ...
                document-based approach of MongoDB, I ensure your data is safe
                and optimized.
              </p>
            </CardContent>
            <CardFooter>
